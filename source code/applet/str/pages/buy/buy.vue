		...
		<view class="">
			<u-waterfall v-model="flowList" ref="uWaterfall1">
				<template v-slot:left="{leftList}">
					<view class="demo-warter" v-for="(item, index) in leftList" :key="index"> <!-- 警告：微信小程序中需要hx2.8.11版本才支持在template中结合其
他组件，比如下方的lazy-load组件 -->
						...
						<view class="demo-tag">
							<view v-if="item.type == '0'" class="demo-tagowner">
								闲置
							</view>
							<view style="margin-left: 0;" v-else class="demotag-text">
