...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const avatarUrl = common_vendor.ref("/static/mine.png");
    const toLogin = () => {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        q: common_vendor.sr(form1, "031d8352-0", {
          "k": "form1"
        }),
        r: common_vendor.p({
          model: loginModel
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Users/LH/Desktop/sh-transaction/source code/applet/str/pages/register/register.vue"]]);
