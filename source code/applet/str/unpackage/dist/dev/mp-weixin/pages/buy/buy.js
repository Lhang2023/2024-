...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getUsedList = async () => {
      let res = await api_good.getBuyListApi({
    ...
    return (_ctx, _cache) => {
      return {
        ...
        i: common_vendor.sr(uWaterfall1, "61153600-2", {
          "k": "uWaterfall1"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Users/LH/Desktop/sh-transaction/source code/applet/str/pages/buy/buy.vue"]]);
