...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const getCateList = async () => {
      let res = await api_good.getCateListApi();
      if (res && res.code == 200) {
        console.log(res);
    ...
    const getUsedList = async () => {
      let res = await api_good.getUsedListApi({
    ...
    return (_ctx, _cache) => {
      return {
        ...
        i: common_vendor.sr(uWaterfall1, "54d6471c-2", {
          "k": "uWaterfall1"
        }),
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "C:/Users/LH/Desktop/sh-transaction/source code/applet/str/pages/unused/unused.vue"]]);
